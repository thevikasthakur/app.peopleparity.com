...
exports.getManagerMessage = getManagerMessage;
exports.getWeeklyMarathonMessage = getWeeklyMarathonMessage;
exports.getCurrentSessionMessage = getCurrentSessionMessage;
const festivals = [
...
function getManagerMessage(context) {
    const { currentHour, dayOfWeek, dayOfMonth, month, trackedHoursToday, trackedHoursWeek, lastActivityScore, isHolidayWeek, currentSessionMinutes, targetDailyHours = 8, targetWeeklyHours = 40 } = context;
...
function getWeeklyMarathonMessage(context) {
...
function getCurrentSessionMessage(sessionMinutes, activityScore) {
...
//# sourceMappingURL=managerMessages.js.map