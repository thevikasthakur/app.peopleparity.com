...
exports.SpikeDetectorV2 = void 0;
exports.getGlobalSpikeDetectorV2 = getGlobalSpikeDetectorV2;
exports.resetGlobalSpikeDetectorV2 = resetGlobalSpikeDetectorV2;
class SpikeDetectorV2 {
    constructor() {
        this.activityHistory = [];
        this.maxHistorySize = 20; // Keep last 20 periods
        this.minHistoryForDetection = 5; // Need more history for better accuracy
        // Adjusted thresholds for better accuracy
        this.spikeThreshold = 4.0; // Higher threshold to reduce false positives
        this.burstThreshold = 3.0; // Allow normal typing bursts
        this.mouseMovementThreshold = 6.0; // Much higher threshold for mouse movement
        this.scrollThreshold = 5.0; // Higher threshold for scroll detection
        // Typing pattern recognition
        this.normalTypingSpeed = 300; // 5 keys per second is normal fast typing
        this.burstTypingSpeed = 400; // Allow bursts up to 6.6 keys per second
        this.sustainedHighSpeed = 500; // Sustained >8 keys per second is suspicious
        // Mouse pattern recognition
        this.normalScrollSpeed = 30; // Normal scrolling up to 30 scrolls per minute
        this.normalMouseDistance = 50000; // Normal mouse movement up to 50k pixels per minute
        this.readingMouseDistance = 10000; // Minimal mouse movement during reading
    }
    /**
     ...
     */
    detectPatternAnomaliesV2(current, history) {
...
exports.SpikeDetectorV2 = SpikeDetectorV2;
// Singleton instance for global spike detection
let globalSpikeDetectorV2 = null;
function getGlobalSpikeDetectorV2() {
    if (!globalSpikeDetectorV2) {
        globalSpikeDetectorV2 = new SpikeDetectorV2();
    }
    return globalSpikeDetectorV2;
}
function resetGlobalSpikeDetectorV2() {
    if (globalSpikeDetectorV2) {
        globalSpikeDetectorV2.reset();
    }
}
//# sourceMappingURL=spikeDetectorV2.js.map