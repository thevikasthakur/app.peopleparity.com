...
const providers = [auth_service_1.AuthService, local_strategy_1.LocalStrategy, jwt_strategy_1.JwtStrategy];
...
if (process.env.SAML_CERT && process.env.SAML_CERT.trim() !== '') {
    ...
    providers.push(saml_strategy_1.MicrosoftSamlStrategy);
}
else {
