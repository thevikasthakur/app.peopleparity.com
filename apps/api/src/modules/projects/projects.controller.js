...
let ProjectsController = (() => {
    ...
    var ProjectsController = _classThis = class {
    ...
    (() => {
        ...
        _getProjects_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Get)()];
        _createProject_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard), (0, common_1.Post)()];
