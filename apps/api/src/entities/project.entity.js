...
let Project = (() => {
    let _classDecorators = [(0, typeorm_1.Entity)('projects')];
    ...
    var Project = _classThis = class {
        constructor() {
            ...
            this.color = (__runInitializers(this, _organization_extraInitializers), __runInitializers(this, _color_initializers, void 0));
            this.isActive = (__runInitializers(this, _color_extraInitializers), __runInitializers(this, _isActive_initializers, void 0));
    ...
    (() => {
        ...
        _organization_decorators = [(0, typeorm_1.ManyToOne)(() => organization_entity_1.Organization, org => org.projects), (0, typeorm_1.JoinColumn)({ name: 'organizationId' })];
        _color_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _isActive_decorators = [(0, typeorm_1.Column)({ default: true })];
        _createdAt_decorators = [(0, typeorm_1.CreateDateColumn)()];
        _updatedAt_decorators = [(0, typeorm_1.UpdateDateColumn)()];
        _sessions_decorators = [(0, typeorm_1.OneToMany)(() => session_entity_1.Session, session => session.project)];
