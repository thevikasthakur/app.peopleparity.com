...
let ActivityPeriod = (() => {
    ...
    let _screenshotId_decorators;
    let _screenshotId_initializers = [];
    let _screenshotId_extraInitializers = [];
    let _screenshot_decorators;
    let _screenshot_initializers = [];
    let _screenshot_extraInitializers = [];
    ...
    var ActivityPeriod = _classThis = class {
        constructor() {
            ...
            this.screenshotId = (__runInitializers(this, _user_extraInitializers), __runInitializers(this, _screenshotId_initializers, void 0));
            this.screenshot = (__runInitializers(this, _screenshotId_extraInitializers), __runInitializers(this, _screenshot_initializers, void 0));
            this.periodStart = (__runInitializers(this, _screenshot_extraInitializers), __runInitializers(this, _periodStart_initializers, void 0));
    ...
    (() => {
        ...
        _sessionId_decorators = [(0, typeorm_1.Column)({ type: 'uuid' })];
        ...
        _screenshotId_decorators = [(0, typeorm_1.Column)({ type: 'uuid', nullable: true })];
        _screenshot_decorators = [(0, typeorm_1.ManyToOne)(() => screenshot_entity_1.Screenshot, screenshot => screenshot.activityPeriods, {
                nullable: true, // Optional relationship
                onDelete: 'SET NULL' // Set to null when screenshot is deleted
            }), (0, typeorm_1.JoinColumn)({ name: 'screenshotId' })];
        ...
        _isValid_decorators = [(0, typeorm_1.Column)({ type: 'boolean', default: true })];
        _classification_decorators = [(0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
        ...
        __esDecorate(null, null, _screenshotId_decorators, { kind: "field", name: "screenshotId", static: false, private: false, access: { has: obj => "screenshotId" in obj, get: obj => obj.screenshotId, set: (obj, value) => { obj.screenshotId = value; } }, metadata: _metadata }, _screenshotId_initializers, _screenshotId_extraInitializers);
        __esDecorate(null, null, _screenshot_decorators, { kind: "field", name: "screenshot", static: false, private: false, access: { has: obj => "screenshot" in obj, get: obj => obj.screenshot, set: (obj, value) => { obj.screenshot = value; } }, metadata: _metadata }, _screenshot_initializers, _screenshot_extraInitializers);
