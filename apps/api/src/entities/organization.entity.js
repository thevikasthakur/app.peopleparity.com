...
let Organization = (() => {
    ...
    (() => {
        ...
        _name_decorators = [(0, typeorm_1.Column)({ type: 'varchar', unique: true })];
        _code_decorators = [(0, typeorm_1.Column)({ type: 'varchar', unique: true })];
        _timezone_decorators = [(0, typeorm_1.Column)({ type: 'varchar', default: 'UTC' })];
        _firstDayOfWeek_decorators = [(0, typeorm_1.Column)({ type: 'varchar', default: 'sunday' })];
