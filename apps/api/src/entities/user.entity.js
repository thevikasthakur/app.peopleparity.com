...
let User = (() => {
    ...
    let _microsoftId_decorators;
    let _microsoftId_initializers = [];
    let _microsoftId_extraInitializers = [];
    let _authProvider_decorators;
    let _authProvider_initializers = [];
    let _authProvider_extraInitializers = [];
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.microsoftId = (__runInitializers(this, _password_extraInitializers), __runInitializers(this, _microsoftId_initializers, void 0));
            this.authProvider = (__runInitializers(this, _microsoftId_extraInitializers), __runInitializers(this, _authProvider_initializers, void 0));
            this.role = (__runInitializers(this, _authProvider_extraInitializers), __runInitializers(this, _role_initializers, void 0));
            ...
            this.timezone = (__runInitializers(this, _lastLogin_extraInitializers), __runInitializers(this, _timezone_initializers, void 0));
            this.createdAt = (__runInitializers(this, _timezone_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (() => {
        ...
        _password_decorators = [(0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
        _microsoftId_decorators = [(0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
        _authProvider_decorators = [(0, typeorm_1.Column)({ type: 'varchar', default: 'local' })];
        _role_decorators = [(0, typeorm_1.Column)({
                type: 'enum',
                enum: ['super_admin', 'org_admin', 'developer'],
                default: 'developer'
            })];
        _organizationId_decorators = [(0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
        ...
        _timezone_decorators = [(0, typeorm_1.Column)({ type: 'varchar', default: 'Asia/Kolkata' })];
        ...
        __esDecorate(null, null, _microsoftId_decorators, { kind: "field", name: "microsoftId", static: false, private: false, access: { has: obj => "microsoftId" in obj, get: obj => obj.microsoftId, set: (obj, value) => { obj.microsoftId = value; } }, metadata: _metadata }, _microsoftId_initializers, _microsoftId_extraInitializers);
        __esDecorate(null, null, _authProvider_decorators, { kind: "field", name: "authProvider", static: false, private: false, access: { has: obj => "authProvider" in obj, get: obj => obj.authProvider, set: (obj, value) => { obj.authProvider = value; } }, metadata: _metadata }, _authProvider_initializers, _authProvider_extraInitializers);
