...
let Session = (() => {
    ...
    var Session = _classThis = class {
        constructor() {
            ...
            this.createdAt = (__runInitializers(this, _task_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
            ...
            __runInitializers(this, _activityPeriods_extraInitializers);
        }
    };
    ...
    (() => {
        ...
        _projectId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        ...
        _task_decorators = [(0, typeorm_1.Column)({ nullable: true })];
